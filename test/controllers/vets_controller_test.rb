...
class VetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vet" do
    assert_difference("Vet.count") do
      post vets_url, params: { vet: { Name: @vet.Name, birthday: @vet.birthday, crew: @vet.crew, dog_type: @vet.dog_type } }
    end
  ...
  test "should update vet" do
    patch vet_url(@vet), params: { vet: { Name: @vet.Name, birthday: @vet.birthday, crew: @vet.crew, dog_type: @vet.dog_type } }
